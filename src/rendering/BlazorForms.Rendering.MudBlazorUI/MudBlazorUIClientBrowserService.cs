...
namespace BlazorForms.Rendering.MudBlazorUI
{
    public class MudBlazorUIClientBrowserService : IClientBrowserService
    {
        ...
        public MudBlazorUIClientBrowserService(IJSRuntime jsRuntime, NavigationManager navigationManager)
        {
            _moduleTask = new(() => jsRuntime.InvokeAsync<IJSObjectReference>(
                "import", "./_content/BlazorForms.Rendering.MudBlazorUI/timeZone.js").AsTask());
