...
{
    public class DialogFormViewModel : FormViewModel, IDialogFormViewModel
    {
        public bool DialogIsOpen { get; set; }
        public string? ItemId { get; private set; }
        public string? FlowType { get; private set; }

        public DialogFormViewModel(ILogger<FormViewModel> logger, IFlowRunProvider flowRunProvider, IDynamicFieldValidator dynamicFieldValidator,
