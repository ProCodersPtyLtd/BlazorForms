...
namespace BlazorForms.Platform.Tests.Rules.SimpleFastRuleEngineTests
{
    public class SimpleFastRuleEngineRuleExecutionTests : TestInfraAssemblyRegistratorBase
    {
        private IFlowRunProvider _flowRunProvider;

        public SimpleFastRuleEngineRuleExecutionTests()
        {
        ...
        public async Task JsonPathBasedExecutionTest()
        {
            ...
            var engine = new SimpleFastRuleEngine(_serviceProvider.GetRequiredService<ILogStreamer>(), pa, this, new JsonPathNavigator(), 
                _serviceProvider.GetRequiredService<IKnownTypesBinder>());

            var model = new Model2 { Client = new ClientModel { BirthDate = DateTime.Now, 
                ResidentialAddress = new AddressModel { PostCode = "2227", Country = "AU" } } };

            var parameters = new RuleExecutionParameters { Model = model, TriggeredRuleCode = "sample1_2", 
                ProcessTaskTypeFullName = "BlazorForms.Platform.Tests.Rules.SimpleFastRuleEngineTests.ProcessTask2" };
            ...
            parameters = new RuleExecutionParameters { Model = newModel, TriggeredRuleCode = "sample1_2", 
                ProcessTaskTypeFullName = "BlazorForms.Platform.Tests.Rules.SimpleFastRuleEngineTests.ProcessTask2" };
        ...
        public async Task AsyncRuleTest()
        {
            ...
            var parameters = new RuleExecutionParameters { Model = model, TriggeredRuleCode = "sampleAsync1_2", 
                ProcessTaskTypeFullName = "BlazorForms.Platform.Tests.Rules.SimpleFastRuleEngineTests.ProcessTask2" };
        ...
        public async Task MoneyCascadingRuleTest()
        {
            ...
            var parameters = new RuleExecutionParameters { Model = model, TriggeredRuleCode = "CascadingMoneyRule1_2", 
            ...
            // CascadingMoneyRule2 should be triggered by changes made to model in CascadingMoneyRule1_2
    ...
    {
        public override string RuleCode => "CascadingMoneyRule2_2";
    ...
    {
        public override string RuleCode => "RepeaterRowRule1_2";
    ...
    {
        public override string RuleCode => "RepeaterRowRule2_2";
        public override RuleTypes RuleType => RuleTypes.DisplayRule;
    ...
    {
        public override string RuleCode => "RepeaterRowRule3_2";
        public override RuleTypes RuleType => RuleTypes.DisplayRule;
    ...
    {
        public override string RuleCode => "RepeaterRowRule4_2";
        public override RuleTypes RuleType => RuleTypes.DisplayRule;
    ...
    {
        public override string RuleCode => "RepeaterRowRule5_2";
        public override RuleTypes RuleType => RuleTypes.DisplayRule;
    ...
    {
        public override string RuleCode => "sample1_2";
        public override RuleTypes RuleType => RuleTypes.DisplayRule;

        public override void Execute(Model2 model)
        {
            model.Client.ResidentialAddress.PostCode = "0000";
            Trigger(SingleField(m => m.Client.ResidentialAddress.PostCode));
            Result.ValidationResult = RuleValidationResult.Ok;
        }
    }
    ...
    {
        public override string RuleCode => "sample2_2";
        public override RuleTypes RuleType => RuleTypes.DisplayRule;

        public override void Execute(Model2 model)
        {
            model.Client.ResidentialAddress.Country = "US";
            Trigger(SingleField(m => m.Client.ResidentialAddress.Country));
        }
    }

    public class ClientIdExistsAsyncRule : FlowRuleAsyncBase<Model2>
    {
        public override string RuleCode => "sampleAsync1_2";
        public override RuleTypes RuleType => RuleTypes.DisplayRule;
        ...
        public override async Task Execute(Model2 model)
        {
            ...
            Trigger(SingleField(m => m.Client.FirstName));
        }
    }
